<%@ Page Language="C#" MasterPageFile="PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="MantenimientoProfesor.aspx.cs" Inherits="SitioWeb.MantenimientoProfesor" %> 
    ...
    <form id="Formulario" runat="server">
        <div>
            ...
            <br />
                ...
                <div class="row">
                    <div class="col-sm">
                        <asp:Label ID="lbl3" Text="ID-Profesor" runat="server" />
